...
<div id="secondary" class="aside sidebar <?php vedanta_sidebar_class(); ?>"
     <?php
     if ( class_exists( 'Woocommerce' ) ):
    ...
    if ( is_single() || is_page() || is_404() || is_search() || is_buddypress() ) {
        if ( is_bbpress() ) {
            if ( vedanta_get_option( 'ved_bbpress_global_sidebar', '0' ) == 1 ) {
                $ved_bbbress_sidebar = vedanta_get_option( 'ved_bbbress_sidebar', 'None' );

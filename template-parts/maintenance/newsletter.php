...
if( 
	...
	&& ( vedanta_check_plugin_active('mailchimp-for-wp/mailchimp-for-wp.php') )
		...
		<div class="container">
			<div class="row justify-content-center text-center">
				<div class="col-md-8 col-md-offset-2"> 
					<h2 class="mntc-tit"><?php esc_html_e('We will notify you when site is ready :', 'godecore' ); ?></h2>
					<form id="mc4wp-form-1" class="notify-form widget_mailchimp mc4wp-form mc4wp-form-<?php echo esc_attr($mailchimp_id);?>" method="post" data-id="<?php echo esc_attr($mailchimp_id);?>" data-name="NewsLetter">
						<div class="mc4wp-form-fields">
							<div class="input-wrapper"><input class="newsletter_email" name="EMAIL" placeholder="<?php esc_attr_e('Your email address', 'godecore' );?>" required="" type="email"></div>
							<input class="newsletter_submit btn btn-base" value="<?php esc_html_e('Notify Me', 'godecore' );?>" type="submit">
							<div class="vedanta-hidden hidden">

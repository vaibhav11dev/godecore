...
<?php
	if ( $ved_maintenance_bg = vedanta_get_option( 'ved_maintenance_bg', '' ) ) {
        $comingsoonimage = $ved_maintenance_bg['url'];
    } 
?>

<body <?php body_class(); ?> <?php if ( vedanta_get_option( 'ved_maintenance_mode' ) == 'comingsoon' ) { ?> style="background: #222 url(<?php echo esc_url($comingsoonimage); ?>) no-repeat fixed center center;background-size:cover" <?php } ?> >
<?php 

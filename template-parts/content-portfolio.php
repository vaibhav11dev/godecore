...
$ved_portfolio_no_item_per_page	 = vedanta_get_option( 'ved_portfolio_no_item_per_page', '10' );
$args				 = array(
	...
	if ( is_array( $all_terms ) && ! empty( $all_terms ) && get_post_meta( $post->ID, 'vedanta_portfolio_filters', true ) != 'no' ):
		...
		<div class="row">
			...
			<ul id="filters" class="portfolio-tabs filters">
			    <li><a href="#" class="current" data-filter="*"><?php echo esc_html_e( 'All', 'godecore' ); ?></a></li>
			...
			while ( $portfolio->have_posts() ): $portfolio->the_post();
				...
				if ( has_post_thumbnail() ) {
					...
					<article class="work-item <?php echo esc_attr($item_classes); ?>">
						...
						<a df href="<?php echo esc_url($permalink); ?>" <?php echo esc_attr($link_target); ?> class="work-link"></a>
					    </div>
					</article>
					<!-- END PORTFOLIO ITEM -->
					<?php

...
if ($ved_header_width == 'full_width') {
	$header_width_class = "container-fluid full-header";
}
?>
        ...
        <div class="<?php echo esc_attr( $header_width_class ); ?>">
            <div class="row">
                <div class="header-row">
                    <div class="header-logo col-md-2 col-sm-6">
					...
					<div class="ved-header-main-menu col-lg-8 col-md-8 col-sm-6 col-xs-6">

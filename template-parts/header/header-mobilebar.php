...
<div id="mobile_top_menu_wrapper" class="hidden-lg-up">
    ...
    <div id="_mobile_user_info"><?php vedanta_topbar_my_account(); ?></div>
    <div class="js-top-menu-bottom">
        <div class="menu-horizontal">
            <h4 class="menu-tit"><i class="ti-menu"></i> <?php echo esc_html__( 'Menu', 'godecore' ); ?></h4>
            <div id="_mobile_menu"></div>
        </div>
        <?php if($ved_cat_menu_status == "enable" && ( $ved_header_type_check == "h1" || $ved_header_type_check == "h2" || $ved_header_type_check == "h4")) { ?>
        <div class="menu-vertical">
            <h4 class="menu-tit"><i class="ti-menu"></i> <?php echo esc_html__( 'Category', 'godecore' ); ?></h4>

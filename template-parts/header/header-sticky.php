<?php
$ved_show_sticky_header_cart = vedanta_get_option( 'ved_show_sticky_header_cart' );
$ved_show_sticky_header_compare = vedanta_get_option( 'ved_show_sticky_header_compare' );
$ved_show_sticky_header_wishlist = vedanta_get_option( 'ved_show_sticky_header_wishlist' );
?>
        ...
        <div class="container container-width">
            <div class="row">
                <div class="header-row">
                    <div class="header-logo col-lg-3 col-md-2 col-sm-3">
                        <div class="d-logo">
                            <!-- YOUR LOGO HERE -->
					...
					<div class="col-lg-9 col-md-10 col-sm-9 fix-header-right">							

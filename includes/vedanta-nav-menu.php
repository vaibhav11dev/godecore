<?php
    /**
     * vedanta_Walker_Nav_Menu
     */
if ( ! class_exists( 'Vedanta_Walker_Nav_Menu' ) ) :

    class Vedanta_Walker_Nav_Menu extends Walker_Nav_Menu {
	    /**
	     * @see   Walker::start_el()
	     * @since 1.0.0
	     *
	    ...
	    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		     ...
		     */
		    if ( vedanta_get_option( 'ved_main_menu_hover_effect', 'rollover' ) == 'disable' ) {
